...
// Embeds the ElevenLabs voice agent that speaks AS Aziz in the first person, so
// visitors can talk to an AI version of him about his work. The agent's system
// prompt and RAG knowledge base are maintained in /elevenlabs (see
